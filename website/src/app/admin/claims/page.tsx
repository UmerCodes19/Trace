    ...
    <div className="space-y-10 pb-20 relative">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[var(--border-color)] pb-10">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl font-black tracking-tighter uppercase text-[var(--foreground)]">Audit <span className="text-jade-primary">Logs</span></h1>
          <p className="text-sm text-jade-primary/60 font-bold uppercase tracking-widest mt-2">Activity History of Claim Submissions</p>
        </motion.div>
        ...
        <div className="flex items-center gap-3 px-5 py-2.5 bg-jade-primary/5 border border-jade-primary/10 rounded-2xl shadow-sm">
           ...
           <span className="text-[10px] font-black uppercase text-jade-primary tracking-widest">System Integrity Active</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        {isLoading ? (
          ...
          <div className="py-24 text-center border border-dashed border-jade-primary/20 rounded-[40px] bg-jade-primary/5">
             ...
             <p className="text-xs font-bold text-jade-primary/40 uppercase tracking-[0.3em]">No activity records found</p>
          </div>
        ) : (
          logs.map((log, i) => (
            <motion.div 
              ...
              <div className="flex flex-col lg:flex-row gap-8 relative z-10">
                <div className="flex-1 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                       <span className="block text-[9px] font-black text-jade-primary/30 uppercase tracking-widest mb-2">Previous State</span>
                       <code className="text-[10px] font-bold text-jade-primary/60 break-all bg-jade-primary/5 p-3 rounded-2xl block border border-jade-primary/5">
                          {log.prev_hash || "INITIAL"}
                       </code>
                    </div>
                    <div>
                       <span className="block text-[9px] font-black text-jade-primary/30 uppercase tracking-widest mb-2">Validation Reference</span>
                ...
                <div className="lg:w-72 flex flex-row lg:flex-col justify-between items-center lg:items-start border-t lg:border-t-0 lg:border-l border-[var(--border-color)] pt-8 lg:pt-0 lg:pl-10">
                   <div>
                      <span className="block text-[9px] font-black text-jade-primary/30 uppercase tracking-widest mb-2">Action Taken</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-black uppercase tracking-tighter text-[var(--foreground)]">Log Authentication</h3>
                <p className="text-[10px] font-bold text-jade-primary uppercase tracking-[0.2em] mt-0.5">System File Verification</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--background)] p-6 rounded-3xl border border-[var(--border-color)] space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-semibold">
                  <div>
                    <span className="block text-[10px] font-black text-sage-secondary/60 uppercase tracking-widest mb-1">RECORD ID</span>
                    <span className="text-[var(--foreground)]">LOG-{selectedLog.id.substring(0, 8)}</span>
                  </div>
                  <div>
                    <span className="block text-[10px] font-black text-sage-secondary/60 uppercase tracking-widest mb-1">LOG TIMESTAMP</span>
                ...
                <div className="border-t border-[var(--border-color)] pt-4 space-y-3">
                  <div>
                    <span className="block text-[10px] font-black text-sage-secondary/60 uppercase tracking-widest mb-1">PREVIOUS REF KEY</span>
                  ...
                  <div>
                    <span className="block text-[10px] font-black text-sage-secondary/60 uppercase tracking-widest mb-1">DATA CONTENT</span>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  ...
                  {verificationResult === "verifying" ? "Recalculating Checksum..." : "Run Authenticity Check"}
                </button>
                ...
                >
                  ...
                  <span>Save Activity Report</span>
                </button>
              </div>
              ...
              {verificationResult === "verifying" && (
                <div className="p-5 border border-dashed border-jade-primary/30 bg-jade-primary/5 rounded-3xl text-center space-y-2">
                  ...
                  <div className="text-xs font-black uppercase text-jade-primary tracking-widest">Analyzing payload structure...</div>
                </div>
              )}
              ...
              {verificationResult === "success" && (
                ...
                >
                  ...
                  <div className="space-y-2 text-xs font-semibold text-sage-secondary">
                    <p>Validation test completed. The calculated hash matches the stored reference exactly. This record is authenticated and accurate.</p>
                    <div className="pt-2">
                      <span className="block text-[9px] font-black uppercase text-emerald-500/60 tracking-wider">MATCHED HASH</span>
              ...
              {verificationResult === "fail" && (
                ...
                >
                  <div className="flex items-center gap-3 text-red-500">
                    ...
                    <span className="text-sm font-black uppercase tracking-wider">❌ FAILED: MISMATCH DETECTED</span>
                  </div>
                  <div className="space-y-2 text-xs font-semibold text-sage-secondary">
                    <p>The calculated verification code does NOT match the stored record. This suggests the entry details have been altered since generation.</p>
                    <div className="pt-2">
                      <span className="block text-[9px] font-black uppercase text-red-500/60 tracking-wider">GENERATED HASH</span>
