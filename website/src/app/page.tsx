...
function SpectralLetter({ char, mouseX, mouseY }: { char: string, mouseX: any, mouseY: any }) {
  ...
  return (
    <span ref={ref} className="relative inline-block" style={{ transformStyle: "preserve-3d" }}>
       <motion.span style={{ zIndex: 10, position: 'relative', display: 'inline-block' }} animate={{ translateZ: 20 }}>
         {char}
       </motion.span>
      ...
      >
        ...
        {image && (
          <div className="absolute inset-0" style={{ transformStyle: "preserve-3d" }}>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 group-hover:opacity-95 transition-opacity" style={{ transform: "translateZ(-30px)" }} />
...
export default function MomentUUMPortfolio() {
  ...
  const teamMembers = [
    { name: "Muhammad Umer Qureshi", role: "Lead Developer", color: "cyan", tag: "// Lead_Dev", align: "left", desc: "Leading the development and technical design of our core systems.", image: "/images/team/umer_qureshi.png" },
